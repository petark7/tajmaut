    ...
    return (
      <div className="mainContainer">
          <div className = "event_card">
                <img src={require('../data/images/events/event_01.jpg')}/>
                    <div className="content">
                        <h4 className="event_date">20/01/2023</h4>
                        <h1 className="event_name">DJ IRIE SCRATCH</h1>
                        <div className = "location">
                            <h3 className = "event_city">Bitola</h3>
                            ...
                            <h3 className="event_venue">Raschekor</h3>
                    </div>
                </div>
          </div>
      </div>
